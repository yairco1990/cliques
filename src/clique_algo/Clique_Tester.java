...
public class Clique_Tester {
	public static int minQ = 2, maxQ = 7;
	public static double TH = 0.68;
	public static String in_file = "graph10.csv";
	...
	static void help() {
		System.out
				.println("Wrong Parameters! should use: java -jar All_Cliques <input file> <round value> <min clique> <max clique> <output file> <max_cliques> <Graph convert flag>");
		System.out
				.println("Wrong Parameters! should use: java -jar All_Cliques test1.csv 0.7 5 7 test1_out.txt 10000 true");
	}
	 ...
	 * for(int i=0;i<c.size();i++) { VertexSet curr = c.elementAt(i);
	 * if(curr.size()>=minQ) os.println(i+") "+curr); } os.close(); try {
